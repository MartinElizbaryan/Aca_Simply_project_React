...
export default function CreatePost() {
  const validationSchema = yup.object().shape({
    ...
    categories: yup.string("Enter Category").required("Category is required"),
    type: yup.string("Enter Type").required("Type is required"),
    questions: yup
      .array()
      .of(
        yup.object().shape({
          title: yup.string("Enter Question title"),
        })
      )
              ...
              formik.values.questions.map((question, index) => {
                return (
                  <Question
                    ...
                    // validationHandle={formik.handleChange}
                    validationHandle={(e) =>
                      formik.setFieldValue(`questions[${index}].title`, e.target.value)
                    }
                    validationValue={question.title}
