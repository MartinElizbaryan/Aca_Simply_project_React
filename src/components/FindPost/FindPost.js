            ...
            <Container maxWidth="lg">
                <Box className={classes.homeContainer}>
                    <Box textAlign="center">
                        <Typography variant="h3" mb={2} color={colors.white}>Have you lost something?</Typography>
                        <Typography variant="p" color={colors.white}>Find your lost item!</Typography>
