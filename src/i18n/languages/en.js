const en = {
  ...
  Step3_text:
    "You can start creating the ad for the lost or found items now to claim the item to the rightful owner. After checking we will post the ad on оur community where everybody can potentially take action in searching for what you have lost.",
  Cancel: "Cancel",
}
